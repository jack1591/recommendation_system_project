...
2. Сформировал кластеры на основе текстов постов (признак text в таблице post_text_df)  
   ...
   2.3. С помощью kmeans посчитал расстояние от каждого поста до каждого кластера (сформировал 15 кластеров), тем самым получил что-то на подобии категорий для постов  
...
### Разделение тренировочной и тестовой выборко
